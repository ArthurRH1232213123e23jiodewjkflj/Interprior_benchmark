...
Run (Pro5000 render node, data-production env code):
    ...
    ~/pro5000_env/.venv_isaacsim_pro5000/bin/python -u \\
        ~/benchmark/scripts/bench_replay.py \\
        --suite ~/benchmark/interprior_bench/suites/cube_lift_follow_v1.yaml \\
...
def _run(args: argparse.Namespace, root: Path) -> int:
    ...
    from interprior_bench.adapters.recorded_teacher import RecordedTeacherAdapter
    from interprior_bench.envs.episode import (
        compose_pose,
    ...
    from interprior_bench.envs.rotation import rotation_matrix_to_quat_wxyz  # noqa: F401
    from interprior_bench.physics import verify as V
    from interprior_bench.render.rollout_viewer import (
        CENTER_PATH_COLORS,
        CENTER_PATH_WIDTHS,
        build_center_path_guide,
        write_rollout_html,
    )
    from interprior_bench.suites.suite import load_suite
    ...
    profile_path = BENCH_ROOT / "interprior_bench/physics/profiles" / suite.physics_profile
    ...
    if inproc_mode:
        ...
        from interprior_bench.adapters.flow_policy_v10 import FlowPolicyV10Adapter
...
def _v10_metrics(
    ...
    from interprior_bench.envs.episode import points_from_pose
