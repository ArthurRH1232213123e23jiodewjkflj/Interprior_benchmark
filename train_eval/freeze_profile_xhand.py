...
# interprior_bench was split into bench_cube_val / bench_multi_val on 2026-08-28;
# the original freeze_profile.py still imports the old path and cannot run. This
# copy points at the surviving module. The original is left untouched.
from bench_cube_val.physics.verify import (  # noqa: E402
    ADVISORY_FIELDS,
    REQUIRED_FIELDS,
)
